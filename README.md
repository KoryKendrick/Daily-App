...
**Bonus points** — *Gratitude* and *Add Journal*, one bonus point each per
...
under the menu — **Gratitude** and **Journal Archive** — newest first.
...
Once it's open at a URL: **iPhone:** open it in **Safari**, then Share → *Add to
Home Screen*. **Android:** menu → *Install app*. It installs as **Daily Success**. Renaming the app later
...
sw.js                        offline cache
assets/                      app icons (SVG plus PNGs; iOS only reads PNG for
